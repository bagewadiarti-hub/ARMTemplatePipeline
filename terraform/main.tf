...
resource "azurerm_resource_group_template_deployment" "storage" {
  ...
  template_content = file("${var.arm_templates_path}/storage_account.json")
...
resource "azurerm_resource_group_template_deployment" "vmss" {
  ...
  template_content = file("${var.arm_templates_path}/vmss.json")
...
resource "azurerm_resource_group_template_deployment" "adf" {
  ...
  template_content = file("${var.arm_templates_path}/adf.json")
...
resource "azurerm_resource_group_template_deployment" "adf_pipeline" {
  ...
  template_content = file("${var.arm_templates_path}/adf_pipeline_trigger.json")
